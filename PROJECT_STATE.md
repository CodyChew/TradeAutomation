...
- use V15's account-risk bucket schedule as the starting point, then test
  daily/max loss constraints, same-symbol stacking limits, and max concurrent
  trade limits;
...
H4/H8/H12/D1/W1. Review docs/v13.html, docs/v14.html, and docs/v15.html. Use
the V15 most-efficient risk bucket row as the first account-constraint
candidate: H4/H8 0.20%, H12/D1 0.30%, W1 0.75%. Keep H4/H8 0.25%, H12/D1
0.30%, W1 0.60% as the growth contrast. Next test daily/max loss and
same-symbol/concurrent execution constraints without changing LP or Force
Strike concept behavior unless needed.
```
