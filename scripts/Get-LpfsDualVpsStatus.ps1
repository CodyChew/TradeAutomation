...
print("market_data_frames_skipped=" + str(heartbeat.get("last_cycle", {}).get("frames_skipped", 0)))
print("market_data_fetch_failure_count=" + str(heartbeat.get("last_cycle", {}).get("market_data_fetch_failures", 0)))
print("cycle_degraded=" + str(heartbeat.get("last_cycle", {}).get("cycle_degraded", False)))
print("cycle_degraded_reason=" + str(heartbeat.get("last_cycle", {}).get("cycle_degraded_reason", "")))
print("latest_market_data_fetch_error=" + str(heartbeat.get("last_cycle", {}).get("latest_market_data_fetch_error", "")))
