...
def _weekly_performance_card() -> str:
    ...
    <section id="weekly-performance" class="card featured">
      ...
      <p>Read-only FTMO and IC weekly monitor that detects actual portfolio starts, checks live/VPS/runtime versions, compares live closed-trade R against each broker's V22 historical weekly distribution, and separately flags broker-PnL account outcome divergence.</p>
      <div class="facts">
