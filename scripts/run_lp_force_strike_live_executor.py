        ...
        try:
            for cycle_index in range(requested_cycles):
                ...
                append_audit_event(
                    ...
                    market_data_fetch_failures=result.market_data_fetch_failures,
                    cycle_degraded=result.cycle_degraded,
                    cycle_degraded_reason=result.cycle_degraded_reason,
                    latest_market_data_fetch_error=result.latest_market_data_fetch_error,
