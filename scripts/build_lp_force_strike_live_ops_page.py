    ...
    checklist_groups = [
        ...
        (
            ...
            [
                ...
                "Phase 1 telemetry, active-position repair, market-data frame skip, and RA-002/RA-003 robustness were deployed before the 2026-07-09 hold. Both lanes are now intentionally stopped under kill switch after operator-approved flatten; do not resume without a reviewed plan.",
...
<body>
  ...
  <main>
    <section id="proof" class="ops-hero" aria-labelledby="proof-title">
      ...
      <p class="callout warning"><strong>Current accepted operating state:</strong> LPFS is on hold after the 2026-07-09 operator-approved flatten. FTMO <code>LPFS_Live</code> and IC <code>LPFS_IC_Live</code> are disabled, kill switches are active, recovery remains disabled, telemetry failures 0 and market-data fetch failures 0 in the last captured heartbeat/status evidence, and broker-authoritative LPFS pending orders plus active positions are 0 on both lanes. The latest deployed runtime boundary before hold was <code>6c4ecb131d7499e455ef42cfeb91ba0bc0a75490</code>. Post-flatten status is expected to show state/broker mismatch because runtime state and journals were intentionally not rewritten.</p>
    ...
    <section id="spread-policy" aria-labelledby="spread-policy-title">
      ...
      <div class="ops-grid">
        {_fact_grid([
            ...
            ("Data collection warning", "frames_skipped", "If one or more symbol/timeframe candle fetches fail, those frames are skipped with one aggregate warning row for the degraded cycle and no signal/order work for failed frames; healthy frames continue and the next cycle retries."),
    ...
    <section id="ic-vps" aria-labelledby="ic-vps-title">
      ...
      <div class="ops-grid">
        {_fact_grid([
            ...
            ("Active-position repair state", "Historical, now held flat", "Historical active-position repair proof recorded IC running on runtime SHA 45efa748423f20881507cda9d4f81e4afe617bde after FTMO proof, with broker-proven stale-position close rows. Later RA-002/RA-003 proof recorded runtime SHA 6c4ecb131d7499e455ef42cfeb91ba0bc0a75490. Current proof is the 2026-07-09 flatten/hold packet: task disabled, kill switch active, broker LPFS pending orders 0, active positions 0, and expected state/broker mismatch because runtime state was not rewritten."),
    ...
    <section id="commands" aria-labelledby="commands-title">
      ...
      <p class="callout warning"><strong>Current accepted operating state:</strong> Stage 5 minimum-safety resumption, Phase 1 telemetry deploy, active-position state/broker repair, market-data frame-skip, and RA-002/RA-003 robustness deploys are historical runtime context. Current proof is the 2026-07-09 operator-approved flatten/hold: both tasks disabled, both kill switches active, recovery disabled, broker LPFS pending orders 0, broker LPFS active positions 0, and expected state/broker mismatch because runtime state and journals were intentionally not rewritten. Do not run reconciliation, run a canary, manually mutate broker exposure, clean historical journals, clear kill switches, enable tasks, or start duplicate runners without a separate reviewed plan.</p>
