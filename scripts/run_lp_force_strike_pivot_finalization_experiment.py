...
<body>
  {dashboard_header_html(
      title="LP + Force Strike V12 Pivot Finalization - by Cody",
      subtitle_html=f"Static V12 report generated from <code>{_escape(run_dir)}</code>. This page keeps the V11-selected portfolio mechanics fixed and compares LP pivot defaults.",
      current_page=current_page,
      section_links=[
          ("#experiment-summary", "Snapshot"),
          ("#overview", "Overview"),
          ("#metric-glossary", "Glossary"),
          ("#pivot-decision", "Pivot Decision"),
          ("#quality-vs-profitability", "Quality"),
          ("#drawdown-smoothness", "Drawdown"),
          ("#no-h4-robustness", "No-H4"),
      ],
  )}
  <main>
