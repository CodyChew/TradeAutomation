...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| lpfs-flatten-hold-20260709 | 2026-07-09 | Live operation / hold | dual | Flattened and contained | current | `reports/live_ops/lpfs_flatten_hold_20260709_050513` | manifest SHA-256 `2e0cf51d45b705cef5a23f5126e330028cf69b3de006a874f6b29d698aef55c0`; final status SHA-256 `e8bba7a9dbdb5cdd37dc2332cff022becf29671a3dbdba644e7e96bc1939e7f1` | Operator-approved LPFS flatten: FTMO and IC tasks disabled, kill switches active, broker `OK`, LPFS pending orders `0`, LPFS active positions `0`; state/broker mismatch expected because runtime state and journals were not rewritten. | No reconciliation-only run, canary, recovery enablement, strategy/risk/sizing/SL/TP/broker-send/config change, production journal edit, or runtime-state edit; only LPFS-managed broker exposure was flattened. | `SESSION_HANDOFF.md` |
...
| lpfs-status-20260627 | 2026-06-27 | Live status | dual | Pass | superseded | `reports/live_ops/lpfs_dual_vps_status_20260627_080624.md` | SHA-256 `b56f0ad7bf543ac157522522173620a01c2ce584b1c4925974738681e616728d` | Superseded recorded same-day status: both lanes running, runtime SHA `6c4ecb1`, kill switches clear, broker OK, recovery disabled, telemetry failures `0`, market-data fetch failures `0`, mismatch count `0`. Exposure counts are historical packet facts only. | Superseded by `lpfs-flatten-hold-20260709`; no live operation is authorized by this row. | `SESSION_HANDOFF.md` |
